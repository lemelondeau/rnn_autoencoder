...
class myAutoEncoder():
    def __init__(self,max_level,hidden_dim,filename="data_4base_5level.csv"):
            ...
            for epoch in range(self._epoch_num):
                ...
                if epoch == self._epoch_num - 1 or total_loss<0.5:# or total_acc>0.985:
                    ...
                    for test_batch in range(self._batch_num+1):
                        ...
                        t, f, code, lro= sess.run([truevalue, final_output,final_state,last_rnn_output], feed_dict=feed)
                    ...
                    file_hidden="twornn_hidden"+filename[4:len(filename)-4]+"_"+str(self._emb_dim)+".csv"
...
if __name__ == '__main__':
   ...
   #filename="data_"+str(num_base)+"base_"+str(max_level)+"level.csv"
    filename="sampled_airline_data.csv"
    myAutoEncoder(max_level,hidden_dim,filename)